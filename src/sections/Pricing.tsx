      ...
      <div className="container">
        ...
        <div className="mt-10 flex flex-col items-center gap-6 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map((tier, index) => (
            <div
              key={index}
              className={twMerge("card", tier.inverse === true && "border-black bg-primary-color text-white")}
            >
              <div className="flex justify-between">
                <h3
                  className={twMerge(
                    "text-lg font-bold text-primary-color/50",
                    tier.inverse === true && "text-white/90",
                  )}
                >
                  {tier.title}
                </h3>
              ...
              <Button
                className={twMerge(
                  "mt-[30px] w-full",
                  tier.inverse === true && "border-white bg-white text-primary-color",
                )}
              >
                {tier.buttonText}
              </Button>
