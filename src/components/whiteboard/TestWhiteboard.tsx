...
const TestWhiteboard = ({ userMindmapDetails }: { userMindmapDetails: MindMapDetailsProps }) => {
  ...
  const PERMISSIONS = ["VIEW", "UPDATE", "DELETE", "SHARE", "EXPORT", "IMPORT", "COPY", "MANAGE_ROLES"];
