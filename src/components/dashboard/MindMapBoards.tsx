    ...
    <div className="w-full space-y-8">
      ...
      >
        <div className="relative group w-full max-w-lg">
          <input
            type="text"
            placeholder={dashboardText("searchBoards")}
            value={searchTerm}
          ...
          />
          <Search
            className="absolute left-4 top-1/2 transform -translate-y-1/2 transition-colors group-focus-within:text-primary-color"
            size={20}
          />
        </div>
      ...
      {userMindmap && userMindmap.length > 0 ? (
        userMindmap.length > 0 ? (
          <motion.div
            variants={container}
            initial="hidden"
            animate="show"
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400 pt-2 border-t dark:border-slate-700">
                        ...
                        <span>{formatDate(mindmap.updatedAt, dashboardText)}</span>
                      </div>
                    </div>
                  </motion.div>
                </Link>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="flex flex-col items-center justify-center min-h-[300px] rounded-2xl border dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 backdrop-blur-lg p-8 relative overflow-hidden"
          >
            <motion.div
            ...
            >
              {dashboardText("noBoardsFound") || "No boards found"}
            </motion.h3>
            ...
            >
              {dashboardText("tryAnotherSearch") || "Try a different search term or clear your search."}
            </motion.p>
          </motion.div>
        )
      ) : (
        ...
        >
          ...
          <motion.h3
            ...
            className="text-2xl font-semibold mb-4 dark:text-white"
          >
            {dashboardText("startYourFirstBoard")}
          </motion.h3>
          ...
          >
            {dashboardText("startYourFirstBoardExplanation")}
          </motion.p>
        </motion.div>
      )}
    </div>
