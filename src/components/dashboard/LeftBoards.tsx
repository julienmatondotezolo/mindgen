        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div>
              <p className="font-bold text-lg text-foreground dark:text-white flex items-center gap-2">
                {leftBoards} {dashboardText("boardsRemaining")}
                <motion.span
                ...
                >
                  {maxMindmap} {dashboardText("total")}
                </motion.span>
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                {dashboardText("youUsed")} {boardLength} {dashboardText("boards")}
              </p>
            </div>
          </motion.article>
          ...
          >
            ...
            <span className="text-sm font-medium text-primary-color">
              {Math.round(progressPercentage)}% {dashboardText("used")}
            </span>
          </motion.div>
        </div>
