...
const MainNode = ({ id, data, selected, setNodes }: CustomNodeProps) => {
  ...
  return (
    <>
      ...
      <Handle type="target" position={Position.Top} id="top" className="mt-[-5px]" />
      <Handle type="target" position={Position.Right} id="right" className="mr-[-5px]" />
      <Handle type="target" position={Position.Bottom} id="bottom" className="mb-[-5px]" />
      <Handle type="target" position={Position.Left} id="left" className="ml-[-5px]" />
    </>
  );
};
